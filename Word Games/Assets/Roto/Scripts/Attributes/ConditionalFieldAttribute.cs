...
public class ConditionalField : PropertyAttribute
{
    ...
    public ConditionalField(string propertyToCheck, object compareValue = null)
    {
...
{
    private ConditionalField Attribute
    {
        get { return _attribute ?? (_attribute = attribute as ConditionalField); }
    }

    private ConditionalField _attribute;
